...
const ApplicationFormPage = () => {
    ...
    const getTripsName = getTrip.map((trips) => {
        return (
   ...
   const getTrips = () => {
    ...
    return (
        <div>
            ...
            <div>
                <select placeholder="Escolha uma viagem" onChange={onChangeSelectId} >Escolha uma viagem
                    {getTripsName}
                </select>
                <div>
                ...
                <div>
                    ...
                    <button onClick={postApplys} >Enviar Formulário</button>
                </div>
            </div>
        </div>
